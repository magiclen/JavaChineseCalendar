...
/**
 * <p>
 * 在Java上實現出西曆農曆轉換的類別。可支援的西曆範圍為1901/2/19~2100/12/31。
 * </p>
 * <p>
...
public class 農曆 {
     ...
     */
    private static final int 最大西曆年 = 2100;

    /**
     * int型別有32位元(31...0)，將第15~3個位元用來分別表示1~13月(含閏年)是否為大月(1為大月有30天；0為小月有29天)。此處有西元1901~2100年的資料。
     */
    ...
    /**
     * int型別有32位元(31...0)，兩年一組，將第8~4個位元用來表示第一年是閏幾月，第3~0個位元用來表示第二年是閏幾月。若該年數值為0，表示該年沒有閏月。此處有西元1901~2100年的資料。
     */
    ...
    /**
     * 儲存西曆年和農曆年開始(該年第一天)的偏差量(天數)。此處有西元1901~2100年的資料。
     */
